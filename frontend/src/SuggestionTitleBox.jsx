...
const NavigationIcon = ({ children }) => {
    return (
        <div className="bg-gray-300 p-3 mx-2 rounded-full shadow-md hover:bg-indigo-500 text-gray-400 hover:text-indigo-200 translate-y-4">
            ...
            <div className="flex w-full justify-between mb-5 mt-7">
                ...
                <div className="flex">
                    ...
                    <div className="flex flex-col pl-4">
                        <h4 className="text-left text-sm text-gray-600 mb-3">New York Hbf</h4>
