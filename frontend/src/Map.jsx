...
const icon = (image, color) => {
    return (
        L.divIcon({
            ...
            html: `<svg style="filter: drop-shadow(2x   px 2px 2px rgb(0 0 0 / 0.4));" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40"><path d="M12 2C8.13 2 5 5.13 5 9c0 3.17 2.95 7.57 6.25 13.13 0.3 0.52 0.59 0.99 0.89 1.46 0.3-0.47 0.59-0.94 0.89-1.46C16.05 16.57 19 12.17 19 9c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" fill="${color}"   stroke-width="0.5"/><circle cx="12" cy="9" r="6" fill="white" stroke="${color}" stroke-width="1"/><text x="7" y="11.3" font-family="Noto Emoji" font-size="8" fill="black">${image}</text></svg>`,
